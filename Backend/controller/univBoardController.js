const univBoardService = require('../service/univBoardService');
...
exports.getBoards = async (req, res, next) => {
    try {
        ...
        const boards = await univBoardService.getBoards(univIdx, searchParams);
...
exports.getBoardDetail = async (req, res, next) => {
    try {
        ...
        const detailBoard = await univBoardService.getBoardDetail(boardIdx);
...
exports.insertBoard = async (req, res, next) => {
    try {
        ...
        const result = await univBoardService.insertBoard(boardData);
...
exports.correctBoard = async (req, res, next) => {
    try {
        const boardData = req.body;
        const result = await univBoardService.correctBoard(boardData);
        res.status(200).json({ success: true, message: result });
    } catch (error) {
        logger.error(error);
        res.status(500).json({ error: 'Internal Server Error' });
...
exports.deleteBoard = async (req, res, next) => {
    try {
        const boardData = req.body;
        const result = await univBoardService.deleteBoard(boardData);
        res.status(200).json({ success: true, message: result });
    } catch (error) {
        logger.error(error);
        res.status(500).json({ error: 'Internal Server Error' });
...
exports.toggleBoardLike = async (req, res, next) => {
    try {
        ...
        const result = await univBoardService.toggleBoardLike(boardIdx, isLiked);
...
exports.getBoardLike = async (req, res, next) => {
    try {
        ...
        const likeCount = await univBoardService.getBoardLike(boardId);
...
exports.getRecentBoardsWithUnivInfo = async (req, res, next) => {
    try {
        const result = await univBoardService.getRecentBoardsWithUnivInfo();
...
exports.getTopViewedBoardsByUniversity = async (req, res, next) => {
    try {
        const result = await univBoardService.getTopViewedBoardsByUniversity();
