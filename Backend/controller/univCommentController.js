const univCommentService = require('../service/univCommentService');
...
exports.getComments = async (req, res) => {
    try {
        ...
        const comments = await univCommentService.getComments(boardIdx);
...
exports.insertComment = async (req, res) => {
    try {
        ...
        await univCommentService.insertComment(commentData);
...
exports.modifyComment = async (req, res) => {
    try {
        ...
        const isUpdated = await univCommentService.modifyComment({ commentPw, commentIdx, commentContent });
...
exports.deleteComment = async (req, res) => {
    try {
        ...
        const isDeleted = await univCommentService.deleteComment({ commentPw, commentIdx });
